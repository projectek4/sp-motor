...
class Konsultasi extends CI_Controller {
	...
	public function analisa()
	{
		...
		$data['media'] = print_data('get_where', array('penyakit', array('id'=>$analisa)), 'media');
		$data['definisi'] = print_data('get_where', array('penyakit', array('id'=>$analisa)), 'definisi');
