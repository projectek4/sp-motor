...
<head>
	...
	<style type="text/css" media="screen">
		...
		.container form {
			...
			position: absolute;
			top: 0;
			left: 0;  /* Enabling 3d space for the transforms */
			-moz-transform-style: preserve-3d;
			-webkit-transform-style: preserve-3d;
			transform-style: preserve-3d;  /* When the forms are flipped, they will be hidden */
			-moz-backface-visibility: hidden;
			-webkit-backface-visibility: hidden;
			backface-visibility: hidden;  /* Enabling a smooth animated transition */
			-moz-transition: 0.8s;
		...
		.container.flipped #recover {
			opacity: 1;  /* Rotating the recover div into view */
		...
		#recover {
			background: #f3f3f3;
			z-index: 1;  /* Rotating the recover password form by default */
			-moz-transform: rotateY(180deg);
			-webkit-transform: rotateY(180deg);
			transform: rotateY(180deg);
		}
	...
	<div class="row">
		<div class="container" id="formContainer">
			<?= form_open('login', array('class'=>'form-signin')).
				heading('APP Login', 3, array('class'=>'form-signin-heading text-center')).
				form_input('username', set_value('username'), array('class'=>'form-control', 'placeholder'=>'nama pengguna', 'autofocus'=>'autofocus')).
				form_password('password', set_value('password'), array('class'=>'form-control', 'placeholder'=>'kata sandi')).
				form_button(array('class'=>'btn btn-lg btn-primary btn-block', 'type'=>'submit'), 'Sign in').
				validation_errors().
				form_close() 
			?>
